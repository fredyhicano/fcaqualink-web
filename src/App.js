  ...
  const renderView = () => {
    if (!isLoggedIn) {
      switch(currentView) {
        ...
        case 'register':
          return <AuthRegister onRegister={handleRegister} onSwitchView={handleSwitchView} />;
        case 'reset':
          return <AuthResetPassword onResetPassword={handleResetPassword} onSwitchView={handleSwitchView} />;
        default:
          return <AuthLogin onLogin={handleLogin} onSwitchView={handleSwitchView} />;
      }
    }
